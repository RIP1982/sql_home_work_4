DROP DATABASE IF  EXISTS home_work_4;
CREATE DATABASE IF NOT EXISTS home_work_4;
USE home_work_4;

CREATE TABLE IF NOT EXISTS `shops` (
	`id` INT,
    `shopname` VARCHAR (100) CHARACTER SET utf8 DEFAULT NULL,
    PRIMARY KEY (id)
);
...
SELECT c.id, c.name, c.shops_id, s.shopname
FROM cats c
JOIN shops s
...
(
	...
	an_name varchar(50) CHARACTER SET utf8 DEFAULT NULL,
	an_cost INT,
	an_price INT,
	an_group INT
);
...
(
	...
	gr_name varchar(50) CHARACTER SET utf8 DEFAULT NULL,
	gr_temp FLOAT(5,1),
...
JOIN Orders o
ON a.an_id=ord_an
WHERE o.ord_datetime BETWEEN '2020-02-05 07:05:14' AND '2020-02-12 07:35:38'
